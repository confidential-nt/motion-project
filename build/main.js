...
/***/ "./src/composition/dragDrop.ts":
/*!*************************************!*\
  !*** ./src/composition/dragDrop.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar DragDrop = /** @class */ (function () {\n    function DragDrop() {\n        var _this = this;\n        var _a, _b, _c, _d, _e, _f, _g;\n        this.itemList = document.querySelector(\".items\");\n        this.main = document.querySelector(\"main\");\n        this.itemY = 0;\n        this.dragOverTarget = null;\n        (_a = this.itemList) === null || _a === void 0 ? void 0 : _a.addEventListener(\"dragstart\", this.handleDragStart.bind(this));\n        (_b = this.main) === null || _b === void 0 ? void 0 : _b.addEventListener(\"drop\", this.handleDrop.bind(this));\n        (_c = this.main) === null || _c === void 0 ? void 0 : _c.addEventListener(\"dragenter\", function (e) {\n            e.preventDefault();\n            if (e.target.classList.contains(\"item\")) {\n                e.target.classList.add(\"item-accent\");\n            }\n        });\n        (_d = this.main) === null || _d === void 0 ? void 0 : _d.addEventListener(\"dragleave\", function (e) {\n            e.preventDefault();\n            if (e.target.classList.contains(\"item\")) {\n                e.target.classList.remove(\"item-accent\");\n            }\n        });\n        (_e = this.main) === null || _e === void 0 ? void 0 : _e.addEventListener(\"dragend\", function (e) {\n            var _a;\n            e.preventDefault();\n            (_a = _this.dragOverTarget) === null || _a === void 0 ? void 0 : _a.classList.remove(\"item-accent\");\n        });\n        (_f = this.main) === null || _f === void 0 ? void 0 : _f.addEventListener(\"dragover\", function (e) {\n            e.preventDefault();\n            _this.dragOverTarget = e.target;\n        });\n        (_g = this.itemList) === null || _g === void 0 ? void 0 : _g.addEventListener(\"drag\", function (e) {\n            e.preventDefault();\n            if (!e.target.classList.contains(\"item\"))\n                return;\n            _this.itemY = e.target.offsetTop + e.offsetY;\n        });\n    }\n    DragDrop.prototype.handleDragStart = function (e) {\n        if (!e.target.classList.contains(\"item\"))\n            return;\n        e.dataTransfer.setData(\"text/plain\", e.target.id);\n    };\n    DragDrop.prototype.handleDrop = function (e) {\n        e.preventDefault();\n        if (!e.target.classList.contains(\"item\") &&\n            !e.target.classList.contains(\"main\") &&\n            !e.target.classList.contains(\"items\"))\n            return;\n        var data = e.dataTransfer.getData(\"text/plain\");\n        var dropItem = document.getElementById(data);\n        if (!dropItem)\n            return;\n        var y = e.target.offsetTop + e.target.offsetHeight / 2;\n        if (this.itemY <= y) {\n            if (e.target.classList.contains(\"item\")) {\n                e.target.before(dropItem);\n            }\n            else if (e.target.classList.contains(\"main\")) {\n                e.target.prepend(dropItem);\n            }\n            else if (e.target.classList.contains(\"items\")) {\n                e.target.prepend(dropItem);\n            }\n        }\n        else if (this.itemY > y) {\n            if (e.target.classList.contains(\"item\")) {\n                e.target.after(dropItem);\n            }\n            else if (e.target.classList.contains(\"main\")) {\n                e.target.append(dropItem);\n            }\n            else if (e.target.classList.contains(\"items\")) {\n                e.target.append(dropItem);\n            }\n        }\n    };\n    return DragDrop;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DragDrop);\n\n\n//# sourceURL=webpack://motion/./src/composition/dragDrop.ts?");
